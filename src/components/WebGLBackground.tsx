...
/**
 * Fond WebGL interactif (Three.js) :
 * - plan shader plein écran (noise + halos rouges)
 * - nuage de particules réactif à la souris
 * Rendu désactivé si prefers-reduced-motion ou WebGL indisponible.
 */
